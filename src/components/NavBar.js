  ...
  return (
    ...
    <nav>
      ...
      <nav className='flex items-center justify-center flex-wrap'>
        <motion.a href="https://github.com/anujoshikool" target={"_blank"}
        whileHover={{y:-2 }}
        whileTap={{scale:0.9}}
        className="w-6 mr-3"
        >
        ...
        <motion.a href="https://www.linkedin.com/in/anuragjoshi1999" target={"_blank"}
        whileHover={{y:-2 }}
        whileTap={{scale:0.9}}
        className="w-6 mr-3"
        >
    ...
    -translate-x-1/2 -translate-y-1/2 bg-yellow-500/70 rounded-lg backdrop-blur-md py-32'>
    <nav className='flex items-center flex-col justify-center' >
        ...
        <CustomMobileLink href="/" title="Projects" className='mx-4' toggle={handleClick}/>

...
className='absolute left-9 top-0 w-[4px] h-full bg-dark origin-top md:w-[2px] md:left-[30px] xs:left-[20px]'/>
            <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                ...
                info={
                    <>
                    <b>Relevant courses work:</b> Software Engineering , DataStructures and Algorithms,
                Cloud Computing,Software Architecture & Design
                </>
                 }
                />
                <Details
                ...
                time='2016-2020' 
                place='Mahatma Gandhi Institute Of Technology'
                info={
                    <>
                <b>Relevant courses work:</b> C , MATLAB , Java and Engineering Mathematics
                </>
                }
                />
